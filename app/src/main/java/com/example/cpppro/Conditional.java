...
public class Conditional extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question1 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsOne);
        question2 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsTwo);
        question3 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsThree);
        question4 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsFour);
        question5 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsFive);
        question6 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsSix);
        question7 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsSeven);
        question8 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsEight);
        question9 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsNine);
        question10 = (RadioButton) findViewById(R.id.rb_Conditional_CorrectAnsTen);
        ...
        mSubmitbutton.setOnClickListener(view -> {
            ...
            if(correctAnswers==10){
                Toast.makeText(Conditional.this, "Congrats, All Answers are Correct \n", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(Conditional.this, "Correct Answers: "+correctAnswers + "/10\n" + wrongAnswers, Toast.LENGTH_SHORT).show();

            }
            Intent intent = new Intent(Conditional.this, ResultScreen.class);
