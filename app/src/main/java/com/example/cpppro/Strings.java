...
public class Strings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question1 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsOne);
        question2 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsTwo);
        question3 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsThree);
        question4 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsFour);
        question5 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsFive);
        question6 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsSix);
        question7 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsSeven);
        question8 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsEight);
        question9 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsNine);
        question10 = (RadioButton) findViewById(R.id.rb_Strings_CorrectAnsThree);
        ...
        mSubmitbutton.setOnClickListener(view -> {
            ...
            if(correctAnswers==10){
                Toast.makeText(Strings.this, "Congrats, All Answers are Correct \n", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(Strings.this, "Correct Answers: "+correctAnswers + "/10\n" + wrongAnswers, Toast.LENGTH_SHORT).show();

            }
            Intent intent = new Intent(Strings.this, ResultScreen.class);
