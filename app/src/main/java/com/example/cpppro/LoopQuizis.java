...
public class LoopQuizis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loop_quizis);

        scroll = (ScrollView) findViewById(R.id.Scroll);

        question1 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsOne);
        question2 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsTwo);
        question3 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsThree);
        question4 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsFour);
        question5 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsFive);
        question6 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsSix);
        question7 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsSeven);
        question8 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsEight);
        question9 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsNine);
        question10 = (RadioButton) findViewById(R.id.rb_Loop_CorrectAnsTen);
        ...
        mSubmitbutton.setOnClickListener(view -> {
            ...
            if(correctAnswers==10){
                Toast.makeText(LoopQuizis.this, "Congrats, All Answers are Correct \n", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(LoopQuizis.this, "Correct Answers: "+correctAnswers + "/10\n" + wrongAnswers, Toast.LENGTH_SHORT).show();

            }
            Intent intent = new Intent(LoopQuizis.this, ResultScreen.class);
