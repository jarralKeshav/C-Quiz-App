...
public class Arrayz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arrayz);

        scroll = (ScrollView) findViewById(R.id.Scroll);

        question1 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsOne);
        question2 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsTwo);
        question3 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsThree);
        question4 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsFour);
        question5 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsFive);
        question6 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsSix);
        question7 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsSeven);
        question8 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsEight);
        question9 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsNine);
        question10 = (RadioButton) findViewById(R.id.rb_Array_CorrectAnsTen);
        ...
        mSubmitbutton.setOnClickListener(view -> {
            ...
            if(correctAnswers==10){
                Toast.makeText(Arrayz.this, "Congrats, All Answers are Correct \n", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(Arrayz.this, "Correct Answers: "+correctAnswers + "/10\n" + wrongAnswers, Toast.LENGTH_SHORT).show();

            }
            Intent intent = new Intent(Arrayz.this, ResultScreen.class);
